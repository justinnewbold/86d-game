...
const FIRST_NAMES = ['Alex', 'Jordan', 'Sam', 'Morgan', 'Casey', 'Riley', 'Taylor', 'Jamie', 'Drew', 'Quinn', 'Avery', 'Skyler', 'Reese', 'Cameron', 'Dakota', 'Finley', 'Hayden', 'Kendall', 'Logan', 'Parker', 'Peyton', 'Sage', 'Blake', 'Charlie', 'Devon', 'Emerson', 'Gray', 'Harper', 'Jesse', 'Kai'];
...
const MENU_PREFIXES = ['Classic', 'House', 'Chef\'s', 'Signature', 'Traditional', 'Modern', 'Artisan', 'Premium', 'Special', 'Gourmet'];
const MENU_SUFFIXES = {
...
export const generateMenuItem = (cuisineId) => {
...
export const generateCompetitorName = () => {
